# -*- coding: utf-8 -*-
"""Smooth_Att_0.9+FSID.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1lJ2VBhu-9pMUO_hNRu2D_EzsJjb3xpgd
"""
...
!unzip '/content/drive/MyDrive/Smooth Attention/input/FSID.zip'
...
# Create datasets
dataset = FireDataset(
    image_dir='/content/Image/Fire',
    mask_dir='/content/Segmentation_Mask/Fire',
    transform=transform
)
