# -*- coding: utf-8 -*-
"""Smooth_Att_0.2+kvasir.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ciNoGYGsVFry6VSDFRD2PR7VIzjsM3cm
"""
...
!unzip '/content/drive/MyDrive/Smooth Attention/input/kvasir-instrument.zip'
...
class KvasirInstrumentDataset(Dataset):
    def __init__(self, root_dir, transform=None):
        ...
        with tarfile.open(os.path.join(root_dir, 'images.tar.gz'), 'r:gz') as tar:
            tar.extractall(path=root_dir)
        with tarfile.open(os.path.join(root_dir, 'masks.tar.gz'), 'r:gz') as tar:
            tar.extractall(path=root_dir)
...
# Create datasets
dataset = KvasirInstrumentDataset(
    root_dir='/content/kvasir-instrument',
    transform=transform
)
...
class SmoothAttention(nn.Module):
    def __init__(self, in_channels, out_channels, threshold=0.2):
