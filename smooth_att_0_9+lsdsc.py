# -*- coding: utf-8 -*-
"""Smooth_Att_0.9+LSDSC.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1wyBlu94zFR4LyNnatkgZNsVjzIqkLt-w
"""
...
!unzip '/content/drive/MyDrive/Smooth Attention/input/LSDSC.zip'
    ...
    def __init__(self, root_dir, transform=None):
        ...
        for species in os.listdir(root_dir):
            ...
            if os.path.isdir(species_dir):
                img_dir = os.path.join(species_dir, species)
                seg_dir = os.path.join(species_dir, species + " GT")
...
# Create datasets
dataset = FishDataset(
    root_dir='/content/Fish_Dataset/Fish_Dataset',
    transform=transform
)
